...
//     2. Then, I open a for-loop to iterate through all the elements of the array. 
//     3. Then, I add an if-else statement to have two cases:
//         a) if the compliment* value exists in the hashmap, return the two indexes whose value add up to the target.
//         b) if the compliment* value does not exist in the hashmap, add it to the hashmap as a value-index pair. 
//     4. It will keep iterating the array until the value is returned since there will always be a solution. 
//
//
